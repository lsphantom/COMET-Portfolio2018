...
// Initial load images
$(this).find('.left-as-image').attr('src', 'samples/asmet10/media/graphics/' + imagePath + leftProduct + '.jpg');
$(this).find('.right-as-image').attr('src', 'samples/asmet10/media/graphics/' + imagePath + rightProduct + '.jpg');
...
$('.as-form').on('change', function() {
	...
	switch (leftProduct) {
		case 'ir':
			$(leftSide).attr('src', 'samples/asmet10/media/graphics/' + imagePath + leftProduct + '.jpg');
			break;
	...
	switch (rightProduct) {
		case 'ir_enh':
			$(rightSide).attr('src', 'samples/asmet10/media/graphics/' + imagePath + rightProduct + '.jpg');
			break;

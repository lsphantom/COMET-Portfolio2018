...
mejs.MediaElementDefaults = {
	...
	// name of flash file
	flashName: 'jquery/meted-player/plugins/flashmediaelement.swf',
	...
	silverlightName: 'jquery/meted-player/plugins/silverlightmediaelement.xap',
...
(function($) {
	...
	$.extend(mejs.MepDefaults, {
		duration: -1,
		timeAndDurationSeparator: '<span class="mejs-split-override"> / </span>'
	});
...
// MODULE MEDIA PLAYER INITIALIZING
$(document).ready(function(e) {
    
// HTML5 VIDEO - Default settings
$(function() {		
		$('.html5video').mediaelementplayer({
			defaultVideoWidth: 640,
			defaultVideoHeight: 480,
			startVolume: 1.0,
			alwaysShowControls: false,
			videoVolume: 'horizontal',
			features: ['playpause','volume','fullscreen','progress','current','duration','tracks'],
...
// HTML5 VIDEO (w/ Autoplay)
$(function() {		
		$('.html5video-autoplay').mediaelementplayer({
			defaultVideoWidth: 640,
			defaultVideoHeight: 480,
			startVolume: 1.0,
			alwaysShowControls: false,
...
// HTML5 VIDEO - Default settings
$(function() {		
		$('.html5video-ani-loop').mediaelementplayer({
			defaultVideoWidth: 640,
			defaultVideoHeight: 480,
			startVolume: 1.0,
			alwaysShowControls: true,
			videoVolume: 'vertical',
			features: ['playpause','fullscreen','progress','current','duration','tracks'],
			pauseOtherPlayers: false,
			// automatically create these translations on load
			translations:['es','fr'],
			// allow the user to add additional translations
...
// ANIMATION LOOP - Default settings
$(function() {
    	$('.animation-loop').mediaelementplayer({
			defaultVideoWidth: 640,
    		defaultVideoHeight: 480,
        	alwaysShowControls: true,
...
// YOUTUBE VIDEO - Default settings
$(function() {
...
// HTML5 AUDIO - Default settings
$(function() {
		$('.html5audio').mediaelementplayer({
			audioWidth: 400,
			audioHeight: 30,
			startVolume: 1.0,
			alwaysShowControls: true,
